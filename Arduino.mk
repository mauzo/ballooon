...
PARSE_BOARD_CMD = $(PARSE_BOARD) $(PARSE_BOARD_OPTS) 2>/dev/null
endif
...
# General arguments
SYS_LIBS      = $(patsubst %,$(ARDUINO_LIB_PATH)/%,$(ARDUINO_LIBS) $(patsubst %,%/utility,$(ARDUINO_LIBS)))
...
$(TARGET_ELF): 	$(LOCAL_OBJS) $(CORE_LIB) $(OTHER_OBJS)
		$(CC) $(LDFLAGS) -o $@ $(LOCAL_OBJS) $(CORE_LIB) $(OTHER_OBJS) $(LIBS)
